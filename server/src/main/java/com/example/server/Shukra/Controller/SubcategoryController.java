...
public class SubcategoryController {
    ...
    public ResponseEntity<Subcategory> getSubcategoryById(@PathVariable String id) throws Exception {
    ...
    public ResponseEntity<Subcategory> updateSubcategory(@PathVariable String id, @RequestBody Subcategory subcategory) throws Exception {
        subcategory.setId(id);
        return ResponseEntity.ok().body(subcategoryService.updateSubcategory(subcategory));
    }

    @DeleteMapping("/subcategories/delete/{id}")
    public HttpStatus deleteSubcategory(@PathVariable String id) {
